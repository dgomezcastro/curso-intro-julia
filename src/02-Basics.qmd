...
Lo natural es elegir la clase "más estricta". 
```{julia}
f(2)
```
...
Sin embargo, podemos hacer la función comportarse distinto según el tipo de entradas que tenga. 
Por ejemplo, es "natural" que `suma` concatene cadenas de texto
