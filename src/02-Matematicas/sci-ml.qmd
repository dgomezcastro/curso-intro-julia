...
using Plots
plot(sol, linewidth=5, title="Soution to linear ODE",
    xaxis="Time (t)", yaxis="u(t) (in μm)", label="My Thick Line!") # legend=false
plot!(sol.t, t -> 0.5 * exp(1.01t), lw=3, ls=:dash, label="True Solution!")
```

`julia` implementa por defecto [`Tsit5`](https://www.sciencedirect.com/science/article/pii/S0898122111004706) en lugar de `Dormund-Prince`
...
## Algunas funcionalidades de `ModelingToolkit.jl`

- [Problemas de optimización](https://docs.sciml.ai/ModelingToolkit/stable/tutorials/optimization/)

- [Modelización con términos estocásticos](https://docs.sciml.ai/ModelingToolkit/stable/tutorials/stochastic_diffeq/)

- [Problemas de control dinámicos](https://docs.sciml.ai/ModelingToolkit/stable/tutorials/dynamic_optimization/)

- [Estimación de parámetros](https://docs.sciml.ai/ModelingToolkit/stable/tutorials/dynamic_optimization/#Parameter-estimation)

- [Identificabilidad de parámetros](https://docs.sciml.ai/ModelingToolkit/stable/tutorials/parameter_identifiability/)

- [Diagramas de bifurcación](https://docs.sciml.ai/ModelingToolkit/stable/tutorials/bifurcation_diagram_computation/)

## [`JumpProcesses.jl`](https://docs.sciml.ai/JumpProcesses/stable/)

# Ecuaciones en Derivadas Parciales

## [WIAS](https://github.com/wias-pdelib) {.center}
...
## [`JuliaFEM.jl`](http://www.juliafem.org/JuliaFEM.jl/stable/)
...
## [Ejemplo](https://jump.dev/JuMP.jl/stable/tutorials/getting_started/getting_started_with_JuMP/#Step-by-step) {.center}
...
## [Symbolics.jl](https://symbolics.juliasymbolics.org/dev/) {.scrollable}
